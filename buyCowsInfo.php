<?php
    ...
    //arrays to store cattle information
    $image = array();
    $text = array();
    $cowId = array();
    $cowTag = array();
    ...
    //index 0 array, for simplicity will hold error values
    $counter="0";
    array_push($image,"ERROR");   
    array_push($text,"ERROR");
    array_push($cowId,"ERROR"); 
    array_push($cowTag,"ERROR");  
    
   
//adds appropriate information to arrays
$counter="1";
